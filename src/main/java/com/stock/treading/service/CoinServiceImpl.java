...
import com.stock.treading.repository.CoinRepository;
...
public class CoinServiceImpl implements CoinService{
    ...
    public String getCoinDetails(String coinId) throws Exception {
        ...
        try {
            ...
            coin.setPriceChangePercentage24h(marketData.get("price_change_percentage_24h").get("usd").asDouble()); //price_change_24h
